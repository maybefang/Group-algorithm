...
class Attention(nn.Module):
    ...
    def __init__(self, 
        ...
        self.qkv = MaskedLinear(embed_dim, embed_dim*3)
...
class Mlp(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc1 = MaskedLinear(in_features, hidden_features)
        self.act = act_layer
        self.fc2 = MaskedLinear(hidden_features, out_features)
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_c=3, embed_dim=768, norm_layer=None):
        ...
        # 输出为[B, C, H, W]
        self.proj = MaskedConv2d(in_c, embed_dim, kernel_size=self.patch_size, stride=self.patch_size) # 进行 patchty 化
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        # Classifier head(s)
        self.head = MaskedLinear(self.num_features, num_classes) if num_classes > 0 else nn.Identity()
